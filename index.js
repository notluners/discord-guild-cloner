...
(async function () {
	setTitle("Sample Cloning | Setup");
	console.log(" ");
	console.log(" ");
	console.log(center(`Thank you for using my script!`.blue, 112));
...
client.on("ready", async() => {
	...
	setTitle("Sample Cloning | Cloning Server...");
  ...
  let region = allowedRegions.includes(guild2.region) ? guild2.region : 'eu-central';
	...
	let guildname =  "[Clone] " + guild1.name;
